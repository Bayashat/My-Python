...
-------------------------------------------------------------------------------------------
#   <4>. You can convert Python objects of the following types, into JSON strings:
...
------------------------------------------------------------------------------------------------------
        ###   <6> When you convert from Python to JSON, Python objects are converted into the JSON (JavaScript) equivalent:
...
2) You can also define the separators, default value is (", ", ": "), which means using a comma and a space to separate each object, 
